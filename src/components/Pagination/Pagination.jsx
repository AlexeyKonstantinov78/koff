...
export const Pagination = ({ pagination }) => {
  ...
  const createPageUpl = (pageNumber) => {
  ...
  const prevPageUrl = prevPageNumber > 0 ? createPageUpl(prevPageNumber) : "";

  const nextPageUrl =
    nextPageNumber <= totalPages ? createPageUpl(nextPageNumber) : "";
  ...
  return (
    <div className={_.pagination}>
      <div className={_.bar}>
        <div
          className={_.barWidth}
          style={{
      ...
      <div className={_.arrows}>
        <Link className={prevPageUrl ? "" : _.disabled} to={prevPageUrl}>
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <Link className={nextPageUrl ? "" : _.disabled} to={nextPageUrl}>
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
