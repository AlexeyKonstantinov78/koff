  ...
  return (
    <section className={_.product}>
      <Container className={_.product__container}>
        <h2 className={_.product__title}>Кресло с подлокотниками</h2>
        ...
        <div className={_.product__info}>
          <p className={_.product__price}>{"5000".toLocaleString()}&nbsp;₽</p>
          <p className={_.product__article}>арт. 16955246986</p>
          <p className={_.product__characteristics}>
            <h3 className={_.product__characteristics_title}>
              Общие характеристики
            </h3>
            <table className={_.table + " " + _.product__characteristics_table}>
              <tr className={_.table__row}>
                <td className={_.table__field}>Тип</td>
                <td className={_.table__value}>Прямой диван</td>
              </tr>
              <tr className={_.table__row}>
                <td className={_.table__field}>Ширина, см</td>
                <td className={_.table__value}>240</td>
              </tr>
              <tr className={_.table__row}>
                <td className={_.table__field}>Глубина, см</td>
                <td className={_.table__value}>99</td>
              </tr>
              <tr className={_.table__row}>
                <td className={_.table__field}>Высота, см</td>
                <td className={_.table__value}>85</td>
              </tr>
              <tr className={_.table__row}>
                <td className={_.table__field}>Бренд</td>
                <td className={_.table__value}>Garda Decor</td>
              </tr>
            </table>
          </p>
          <div className={_.product__btns}>
            <button className={_.product__btn} data-id="29">
              В корзину
            </button>
            <button className={_.product__like} data-id="29">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
